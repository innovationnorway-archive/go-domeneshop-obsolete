...
func (o NS) MarshalJSON() ([]byte, error) {
...
type NullableNS struct {
	value *NS
	isSet bool
}

func (v NullableNS) Get() *NS {
	return v.value
}

func (v *NullableNS) Set(val *NS) {
	v.value = val
	v.isSet = true
}

func (v NullableNS) IsSet() bool {
	return v.isSet
}

func (v *NullableNS) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNS(val *NS) *NullableNS {
	return &NullableNS{value: val, isSet: true}
}

func (v NullableNS) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNS) UnmarshalJSON(src []byte) error {
	v.isSet = true
