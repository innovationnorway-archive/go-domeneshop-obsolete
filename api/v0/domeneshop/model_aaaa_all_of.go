...
// AAAAAllOf struct for AAAAAllOf
type AAAAAllOf struct {
...
func (o AAAAAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAAAAAllOf struct {
	value *AAAAAllOf
	isSet bool
}

func (v NullableAAAAAllOf) Get() *AAAAAllOf {
	return v.value
}

func (v *NullableAAAAAllOf) Set(val *AAAAAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAAAAAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAAAAAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAAAAAllOf(val *AAAAAllOf) *NullableAAAAAllOf {
	return &NullableAAAAAllOf{value: val, isSet: true}
}

func (v NullableAAAAAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAAAAAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
