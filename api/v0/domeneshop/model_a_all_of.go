...
func (o AAllOf) MarshalJSON() ([]byte, error) {
...
type NullableAAllOf struct {
	value *AAllOf
	isSet bool
}

func (v NullableAAllOf) Get() *AAllOf {
	return v.value
}

func (v *NullableAAllOf) Set(val *AAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAAllOf(val *AAllOf) *NullableAAllOf {
	return &NullableAAllOf{value: val, isSet: true}
}

func (v NullableAAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
