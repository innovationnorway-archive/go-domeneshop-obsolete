...
func (o NSAllOf) MarshalJSON() ([]byte, error) {
...
type NullableNSAllOf struct {
	value *NSAllOf
	isSet bool
}

func (v NullableNSAllOf) Get() *NSAllOf {
	return v.value
}

func (v *NullableNSAllOf) Set(val *NSAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableNSAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableNSAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNSAllOf(val *NSAllOf) *NullableNSAllOf {
	return &NullableNSAllOf{value: val, isSet: true}
}

func (v NullableNSAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNSAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
