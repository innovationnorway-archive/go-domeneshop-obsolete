...
// ANAMEAllOf struct for ANAMEAllOf
type ANAMEAllOf struct {
...
func (o ANAMEAllOf) MarshalJSON() ([]byte, error) {
...
type NullableANAMEAllOf struct {
	value *ANAMEAllOf
	isSet bool
}

func (v NullableANAMEAllOf) Get() *ANAMEAllOf {
	return v.value
}

func (v *NullableANAMEAllOf) Set(val *ANAMEAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableANAMEAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableANAMEAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableANAMEAllOf(val *ANAMEAllOf) *NullableANAMEAllOf {
	return &NullableANAMEAllOf{value: val, isSet: true}
}

func (v NullableANAMEAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableANAMEAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
