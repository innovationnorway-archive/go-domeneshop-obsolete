...
func (o ANAME) MarshalJSON() ([]byte, error) {
...
type NullableANAME struct {
	value *ANAME
	isSet bool
}

func (v NullableANAME) Get() *ANAME {
	return v.value
}

func (v *NullableANAME) Set(val *ANAME) {
	v.value = val
	v.isSet = true
}

func (v NullableANAME) IsSet() bool {
	return v.isSet
}

func (v *NullableANAME) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableANAME(val *ANAME) *NullableANAME {
	return &NullableANAME{value: val, isSet: true}
}

func (v NullableANAME) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableANAME) UnmarshalJSON(src []byte) error {
	v.isSet = true
