...
func (o TXT) MarshalJSON() ([]byte, error) {
...
type NullableTXT struct {
	value *TXT
	isSet bool
}

func (v NullableTXT) Get() *TXT {
	return v.value
}

func (v *NullableTXT) Set(val *TXT) {
	v.value = val
	v.isSet = true
}

func (v NullableTXT) IsSet() bool {
	return v.isSet
}

func (v *NullableTXT) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTXT(val *TXT) *NullableTXT {
	return &NullableTXT{value: val, isSet: true}
}

func (v NullableTXT) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTXT) UnmarshalJSON(src []byte) error {
	v.isSet = true
